...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("C:/xampp/htdocs/final/training_data.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("C:/xampp/htdocs/final/test_data.csv")
...
# Heading
w2 = Label(root, justify=LEFT, text="               QUICK CONSULT", fg="white", bg="lightblue")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=4, padx=100)
w2 = Label(root, justify=LEFT, text="              DISEASE PREDICTION", fg="white", bg="lightblue")
w2.config(font=("Aharoni", 28))
w2.grid(row=2, column=0, columnspan=8, padx=100)

# labels
NameLb = Label(root, text="Name of the Patient", fg="white", bg="black")
NameLb.grid(row=6, column=1, columnspan=8, pady=15, sticky=W)
...
S4Lb.grid(row=14, column=1, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5", fg="yellow", bg="black")
S5Lb.grid(row=16, column=1, pady=10, sticky=W)


lrLb = Label(root, text="DecisionTree", fg="white", bg="red")
lrLb.grid(row=18, column=1, pady=10,sticky=W)

destreeLb = Label(root, text="RandomForest", fg="white", bg="red")
destreeLb.grid(row=20, column=1, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="white", bg="red")
ranfLb.grid(row=22, column=1, pady=10, sticky=W)
...
S1En.grid(row=8, column=2)

S2En = OptionMenu(root, Symptom2,*OPTIONS)
S2En.grid(row=10, column=2)

S3En = OptionMenu(root, Symptom3,*OPTIONS)
S3En.grid(row=12, column=2)

S4En = OptionMenu(root, Symptom4,*OPTIONS)
S4En.grid(row=14, column=2)

S5En = OptionMenu(root, Symptom5,*OPTIONS)
S5En.grid(row=16, column=2)
...
t1.grid(row=18, column=2, padx=10)

t2 = Text(root, height=1, width=40,bg="orange",fg="black")
t2.grid(row=20, column=2 , padx=10)

t3 = Text(root, height=1, width=40,bg="orange",fg="black")
t3.grid(row=22, column=2 , padx=10)

w2 = Label(root, justify=LEFT, text="               QIDAS INFO", fg="white", bg="lightblue")
w2.config(font=("Elephant", 10))
w2.grid(row=26, column=0, columnspan=4, padx=100)
root.mainloop()
