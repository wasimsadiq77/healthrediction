...
<body>
  ...
  <form method="post" action="quickprocess.php" style="font-size: 24px">
    user name:<br>
    ...
    <label>Consultation type:</label><br>
     <select id="type" name="type" style="font-size: 24px">
      <option value="mobile health" size="1">Quick Consultation</option>
    ...
    <br>
    cough:<br>
    <input type="text" name="cough">
    <br>
    chills:<br>
    <input type="text" name="chills">
    <br>
    dehydration:<br>
    <input type="text" name="dehydration">
    <br>
    fatigue:<br>
    <input type="text" name="fatigue">
    <br>
    vomiting:<br>
    <input type="text" name="vomiting">
    <br>
    Diarrhea:<br>
    <input type="text" name="diarrhea">
    <br>
    headache:<br>
    <input type="text" name="headache">
    <br>
    chestpain:<br>
    <input type="text" name="chestpain">
    <br>
    Runny:<br>
    <input type="text" name="runny">
    <br>
    Sorethroat:<br>
    <input type="text" name="sorethroat">
    <br>
    asthma:<br>
    <input type="text" name="asthma">
    <br>
    diabetes:<br>
    ...
    <br>
     lungdisease :<br>
    <input type="text" name="lungdisease">
    <br><br>
